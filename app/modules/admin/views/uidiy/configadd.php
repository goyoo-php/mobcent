        ...
        <div class="reward-edit">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" id="form" action ="<?php echo Yii::app()->createAbsoluteUrl('admin/uidiy/addconfig') ?>" method="post" enctype="multipart/form-data". > 
                        <div class="form-group">
                            <label for="" class="col-sm-2 control-label">模块名称：</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="name" id="name" required autofocus autocomplete="off">                
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                ...
                                <input type="text" class="form-control" name="icon_text" style="display: none" id="icon_text" >
