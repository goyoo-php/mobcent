    ...
    <div class="panel-body">
        <div class="activ-list">
            ...
            <?php endif; ?>
             ...
             <div class="activ text-center">
                <a href="<?php echo $this->dzRootUrl; ?>/mobcent/app/web/index.php?r=admin/reward/rewardcount&show=1" target="main"><img src="<?php echo $this->rootUrl.'/images/admin/module-default.png'; ?>" class="img-rounded"></a>
                <div><small>邀请注册统计</small></div>
            </div>
        </div>
