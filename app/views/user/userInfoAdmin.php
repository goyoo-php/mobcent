        ...
        <table cellpadding="0" cellspacing="0" class="fwin" width="100%">
            <tr>
                ...
                <select name="pageselect" onchange="self.location.href=options[selectedIndex].value" >
                    <option value="<?php echo $base;?>" <?php if ($action == "base") {echo "selected='selected'";}?>><?php echo WebUtils::lp("user_userInfoAdmin_baseInfo");?><!--基本资料--></option>
                    <option value="<?php echo $contact;?>" <?php if ($action == "contact") {echo "selected='selected'";}?>><?php echo WebUtils::lp("user_userInfoAdmin_contact");?><!--联系方式--></option> 
                    <option value="<?php echo $edu;?>" <?php if ($action == "edu") {echo "selected='selected'";}?>><?php echo WebUtils::lp("user_userInfoAdmin_education");?><!--教育情况--></option>
                    <option value="<?php echo $work;?>" <?php if ($action == "work") {echo "selected='selected'";}?>><?php echo WebUtils::lp("user_userInfoAdmin_work");?><!--工作情况--></option>
                    <option value="<?php echo $info;?>" <?php if ($action == "info") {echo "selected='selected'";}?>><?php echo WebUtils::lp("user_userInfoAdmin_personal");?><!--个人信息--></option>
                </select>
            </tr>
            <tr>
